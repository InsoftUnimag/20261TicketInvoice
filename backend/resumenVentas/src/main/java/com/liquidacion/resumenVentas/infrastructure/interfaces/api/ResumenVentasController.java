...
import com.liquidacion.resumenVentas.application.usecase.ConsultarResumenVentasUseCase;
...
public class ResumenVentasController {
    ...
    public ResponseEntity<ConsultarResumenVentasResponse> consultarResumenVentas(@PathVariable("id") Long eventoId) {
